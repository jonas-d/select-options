...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency "rails", "3.2.8"
  spec.add_runtime_dependency "activerecord", "3.2.8"
  spec.add_runtime_dependency "actionpack", "3.2.8"  # required for action_view
  ...
  spec.add_development_dependency "xml-simple", "1.1.2"
end
